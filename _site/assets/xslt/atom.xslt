...
<meta charset="utf-8">
	...
	<meta name="description" content="FronteiraCast é uma nova forma de levar informações às pessoas de uma forma prática. Para saber mais clique">
	...
	<meta property="og:description" content="FronteiraCast é uma nova forma de levar informações às pessoas de uma forma prática. Para saber mais clique">
	<meta property="og:url" content="http://localhost:4000/feeling-responsive/assets/xslt/atom.xslt">
	<meta property="og:locale" content="en_EN">
	<meta property="og:type" content="website">
	<meta property="og:site_name" content="FronteiraCast">
	...
	<meta name="twitter:description" content="FronteiraCast é uma nova forma de levar informações às pessoas de uma forma prática. Para saber mais clique">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000/feeling-responsive" class="icon-tree"> FronteiraCast</a></h1>
    </li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/feeling-responsive/" title="FronteiraCast – Seja bem vindo ao podcast FronteiraCast.">
				<img src="http://localhost:4000/feeling-responsive/assets/img/logo.png" alt="FronteiraCast – Seja bem vindo ao podcast FronteiraCast.">
			</a>
        ...
        <div class="row">
          <div class="medium-6 large-5 columns">
            ...
            <p class="shadow-black">
              FronteiraCast é uma nova forma de levar informações às pessoas de uma forma prática. Para saber mais clique 
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>Criado por estudantes do curso de Ciência da Computação da UFFS Campus Chapecó, com base em <a href="http://phlow.github.io/feeling-responsive/">Feeling Responsive</a>.</p>
          </section>

          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
            
              <li><a href="https://github.com/CleissonVieira/fronteiracast.github.io" target="_blank" class="icon-github" title="Code und mehr..."></a></li>
            
              <li><a href="http://twitter.com/phlow" target="_blank" class="icon-instagram" title="Immer das Neuste von Phlow gibt es auf Twitter"></a></li>
